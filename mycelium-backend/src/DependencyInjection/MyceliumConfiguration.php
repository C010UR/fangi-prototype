                ...
                ->arrayNode('oauth')
                    ...
                    ->children()
                        ...
                        ->scalarNode('jwt_algorithm')
                            ...
                            ->info('JWT algorithm')
                        ->end()
                        ->integerNode('authorization_code_ttl')
                            ->defaultValue(600)
                            ->info('Authorization code TTL in seconds')
                        ->end()
                        ...
                        ->end()
                        ->integerNode('id_token_ttl')
                            ->defaultValue(3600)
                            ->info('ID token TTL in seconds')
                        ->end()
                    ->end()
                ->end()
            ->end();
