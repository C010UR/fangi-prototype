...
#[OAC\Schema('#/components/schemas/ModuleForm')]
class ModuleType extends AbstractType implements PostSubmitFormInterface
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('description', TextType::class, [
                'invalid_message' => 'form.description.invalid',
                'constraints' => [
                    new Assert\Length(max: 4096, maxMessage: 'form.description.too_long'),
                ],
                'required' => false,
            ])
